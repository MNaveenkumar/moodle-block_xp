...
class provider implements
    ...
    public static function _export_user_data(approved_contextlist $contextlist) {
        ...
        $path = [$levelup, get_string('level', 'block_xp')];
        ...
        $path = [$levelup, get_string('logs', 'core')];
        ...
        $flushlogs($lastcourseid, $logs); // Flush the last iteration.
        $recordset->close();
    }
    ...
    public static function _delete_data_for_user(approved_contextlist $contextlist) {
        ...
        foreach ($contextlist as $context) {
            ...
            $db->delete_records('block_xp', ['courseid' => $courseid, 'userid' => $userid]);
            $db->delete_records('block_xp_log', ['courseid' => $courseid, 'userid' => $userid]);
